...
if __name__ == '__main__':
    ...
    Data = [NeurABM,SIS,NN,Tree,NB,XGBoost,AEKNN,Stay]
    
    Method = ['NeurABM','SIS-ABM','Feedforward neural network','Decision tree','Naive bayes','XGBoost','Autoencoder + KNN','Length of stay']
    ...
    plt.axhline(y = 0.925,color='#929591',linewidth=1,linestyle="dashdot")
    plt.axhline(y = 0.95,color='#929591',linewidth=1,linestyle="dashdot")
    plt.axhline(y = 0.975,color='#929591',linewidth=1,linestyle="dashdot")

    for ii in np.arange(0.05, 1.01, 0.05):
        plt.axvline(x=ii,color='#929591',linewidth=1,alpha=0.3,linestyle="dashdot")
    for ii in np.arange(0.905, 1.001, 0.005):
        plt.axhline(y=ii,color='#929591',linewidth=1,alpha=0.3,linestyle="dashdot")
    ...
    plt.ylim(0.9,1)
    plt.xticks([0,0.25,0.5,0.75,1],['0','0.25','0.5','0.75','1'],fontsize=24)
    plt.yticks([0.9,0.925,0.95,0.975,1],['0.9','0.925','0.95','0.975','1'],fontsize=24)
